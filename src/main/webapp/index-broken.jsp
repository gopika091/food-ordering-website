...
<body>
    ...
    <div class="container">
        ...
        <section class="restaurants">
            ...
            <div class="restaurants-grid">
                <%
                // Get restaurants from the database with enhanced error handling
                try {
        ...
        <section class="all-restaurants" id="allRestaurantsSection" style="display: none;">
            <div class="section-title">
                <h2>All Restaurants</h2>
                <p>Complete list of restaurants in your area</p>
                <button onclick="toggleAllRestaurants()" class="btn btn-outline" id="hideAllBtn" style="margin-top: 10px; display: inline-block;">Show Featured Only</button>
            </div>
            ...
            <div class="restaurants-grid">
                ...
                <%
                    ...
                    out.println("<div class='no-restaurants'><h3>Error loading all restaurants</h3><p>" + e.getMessage() + "</p></div>");
                }
                %>
            </div>
        </section>
    ...
    <script>
        function toggleAllRestaurants() {
            const featuredSection = document.querySelector('.restaurants');
